# Examples
This is a pretty huge list of examples. You can download and test them out from the [`examples`](https://github.com/startling/argent/tree/master/examples) directory, too.
